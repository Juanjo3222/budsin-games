(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      "html[data-site-theme='dark'] .title { background: linear-gradient(140deg, rgba(12, 20, 36, 0.96), rgba(8, 16, 32, 0.92)), linear-gradient(135deg, rgba(99, 212, 255, 0.08), rgba(37, 99, 235, 0.08)) !important; border-color: rgba(148, 163, 184, 0.3) !important; box-shadow: 0 24px 64px rgba(0, 0, 0, 0.34) !important; }",
      ...
      "html[data-site-theme='dark'] .title::after { background: radial-gradient(circle at 30% 30%, rgba(255, 104, 110, 0.16), transparent 52%), radial-gradient(circle at 70% 70%, rgba(99, 212, 255, 0.14), transparent 46%) !important; opacity: 0.7 !important; }",
