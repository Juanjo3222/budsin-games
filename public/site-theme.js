(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      "html[data-site-theme='light'] .topbar, html[data-site-theme='light'] .frame-shell, html[data-site-theme='light'] #unity-container, html[data-site-theme='light'] #c2canvasdiv, html[data-site-theme='light'] .note, html[data-site-theme='light'] #loading-panel { border-color: rgba(255, 255, 255, 0.82) !important; }",
      ...
      "html[data-site-theme='light'] .topbar { background: linear-gradient(135deg, rgba(255, 255, 255, 0.96), rgba(246, 249, 252, 0.88)), linear-gradient(135deg, rgba(239, 63, 69, 0.08), rgba(45, 174, 255, 0.08)) !important; box-shadow: 0 24px 64px rgba(15, 23, 42, 0.12) !important; }",
      ...
      "html[data-site-theme='dark'] .title::before { background: rgba(148, 163, 184, 0.16) !important; color: #dbeafe !important; }",
      "html[data-site-theme='light'] .note, html[data-site-theme='light'] #loading-panel { background: rgba(255, 255, 255, 0.78) !important; box-shadow: 0 16px 36px rgba(15, 23, 42, 0.08) !important; }",
      "html[data-site-theme='dark'] .note, html[data-site-theme='dark'] #loading-panel { background: rgba(9, 15, 28, 0.78) !important; box-shadow: 0 16px 36px rgba(0, 0, 0, 0.26) !important; }",
      "html[data-site-theme='dark'] body::before { background: linear-gradient(180deg, rgba(255, 104, 110, 0.88) 0%, rgba(239, 63, 69, 0.66) 100%) !important; box-shadow: inset 0 0 0 2px rgba(255, 255, 255, 0.18) !important; }",
      "html[data-site-theme='dark'] body::after { background: linear-gradient(180deg, rgba(99, 212, 255, 0.88) 0%, rgba(37, 99, 235, 0.66) 100%) !important; box-shadow: inset 0 0 0 2px rgba(255, 255, 255, 0.18) !important; }",
